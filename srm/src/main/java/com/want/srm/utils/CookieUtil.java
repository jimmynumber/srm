...
public final class CookieUtil {
	 ...
	 */
	public static void setCookie(HttpServletRequest request, HttpServletResponse response, String cookieName,
			String cookieValue, boolean isEncode, String domain) throws Exception {
		setCookie(request, response, cookieName, cookieValue, -1, isEncode, domain);
	}
	 ...
	 */
	public static void setCookie(HttpServletRequest request, HttpServletResponse response, String cookieName,
			String cookieValue, int cookieMaxage, boolean isEncode, String domain) throws Exception {
		doSetCookie(request, response, cookieName, cookieValue, cookieMaxage, isEncode, domain);
	}
